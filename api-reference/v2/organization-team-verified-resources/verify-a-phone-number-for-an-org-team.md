...
````yaml /api-reference/v2/openapi.json post /v2/organizations/{orgId}/teams/{teamId}/verified-resources/phones/verification-code/verify
openapi: 3.0.0
info:
...
paths:
  /v2/organizations/{orgId}/teams/{teamId}/verified-resources/phones/verification-code/verify:
    post:
      ...
      description: >-
        Use code to verify a phone number. Required membership role: `team
