...
````yaml /api-reference/v2/openapi.json delete /v2/me/ooo/{oooId}
openapi: 3.0.0
info:
...
paths:
  /v2/me/ooo/{oooId}:
    delete:
      tags:
        - Out of Office
      summary: Delete an out-of-office entry for the authenticated user
      description: >-
        If accessed using an OAuth access token, the `SCHEDULE_WRITE` scope is
        required.
      operationId: UserOOOController_deleteMyOOO
      parameters:
        - name: Authorization
          in: header
          description: >-
