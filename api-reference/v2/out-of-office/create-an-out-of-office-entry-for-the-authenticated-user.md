...
````yaml /api-reference/v2/openapi.json post /v2/me/ooo
openapi: 3.0.0
info:
...
paths:
  /v2/me/ooo:
    post:
      tags:
        - Out of Office
      summary: Create an out-of-office entry for the authenticated user
      description: >-
        If accessed using an OAuth access token, the `SCHEDULE_WRITE` scope is
        required.
      operationId: UserOOOController_createMyOOO
      parameters:
        - name: Authorization
          in: header
          description: >-
