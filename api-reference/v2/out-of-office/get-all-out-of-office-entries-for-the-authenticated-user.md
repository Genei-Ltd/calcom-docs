...
````yaml /api-reference/v2/openapi.json get /v2/me/ooo
openapi: 3.0.0
info:
...
paths:
  /v2/me/ooo:
    get:
      tags:
        - Out of Office
      summary: Get all out-of-office entries for the authenticated user
      description: >-
        If accessed using an OAuth access token, the `SCHEDULE_READ` scope is
        required.
      operationId: UserOOOController_getMyOOO
      parameters:
        - name: Authorization
          in: header
          description: >-
