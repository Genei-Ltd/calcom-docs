...
# Create a phone call for an organization team event type
...
````yaml /api-reference/v2/openapi.json post /v2/organizations/{orgId}/teams/{teamId}/event-types/{eventTypeId}/create-phone-call
openapi: 3.0.0
info:
...
paths:
  /v2/organizations/{orgId}/teams/{teamId}/event-types/{eventTypeId}/create-phone-call:
    post:
      ...
      summary: Create a phone call for an organization team event type
      description: >-
      ...
      operationId: OrganizationsEventTypesController_2026_06_12_createPhoneCall
      parameters:
