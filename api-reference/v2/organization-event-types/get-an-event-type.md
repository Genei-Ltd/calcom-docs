...
````yaml /api-reference/v2/openapi.json get /v2/organizations/{orgId}/teams/{teamId}/event-types/{eventTypeId}
openapi: 3.0.0
info:
...
paths:
  /v2/organizations/{orgId}/teams/{teamId}/event-types/{eventTypeId}:
    get:
      ...
      operationId: OrganizationsEventTypesController_2026_06_12_getTeamEventType
      parameters:
