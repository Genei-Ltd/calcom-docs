...
# List organization team event types
...
````yaml /api-reference/v2/openapi.json get /v2/organizations/{orgId}/teams/{teamId}/event-types
openapi: 3.0.0
info:
...
paths:
  /v2/organizations/{orgId}/teams/{teamId}/event-types:
    get:
      ...
      summary: List organization team event types
      description: >-
        ...
        Hidden event types and hidden booking fields are returned only to team
        administrators or owners, and parent-organization administrators or
        owners. Other callers see public event types and visible booking fields.
        Authentication is optional.
      operationId: OrganizationsEventTypesController_2026_06_12_getTeamEventTypes
      parameters:
        ...
        - name: hostsLimit
          ...
          in: query
          description: >-
            Specifies the maximum number of hosts to include in the response.
            This limit helps optimize performance. If not provided, all Hosts
            will be fetched.
          schema:
            type: number
        - name: sortCreatedAt
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/GetTeamEventTypesOutput_2026_06_12'
components:
  schemas:
    GetTeamEventTypesOutput_2026_06_12:
      type: object
      properties:
        status:
          enum:
