...
````yaml /api-reference/v2/openapi.json delete /v2/organizations/{orgId}/webhooks/{webhookId}
openapi: 3.0.0
info:
  ...
  /v2/organizations/{orgId}/webhooks/{webhookId}:
    delete:
      ...
      description: >-
        ...
        `webhook.delete`. Learn more about API access control at
        https://cal.com/docs/api-reference/v2/access-control. If accessed using
        an OAuth access token, the `ORG_WEBHOOK_WRITE` scope is required.
