...
````yaml /api-reference/v2/openapi.json patch /v2/organizations/{orgId}/routing-forms/{routingFormId}/responses/{responseId}
openapi: 3.0.0
info:
  ...
  /v2/organizations/{orgId}/routing-forms/{routingFormId}/responses/{responseId}:
    patch:
      ...
      description: >-
        ...
        an OAuth access token, the `ORG_ROUTING_FORM_WRITE` scope is required.
