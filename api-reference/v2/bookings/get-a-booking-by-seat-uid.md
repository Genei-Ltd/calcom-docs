...
````yaml /api-reference/v2/openapi.json get /v2/bookings/by-seat/{seatUid}
openapi: 3.0.0
info:
...
paths:
  /v2/bookings/by-seat/{seatUid}:
    get:
      ...
      description: >-
        Get a seated booking by its seat reference UID. This is useful when you
        have a seatUid from a seated booking and want to retrieve the full
        booking details.
      ...
      operationId: BookingsController_2026_02_25_getBookingBySeatUid
      parameters:
