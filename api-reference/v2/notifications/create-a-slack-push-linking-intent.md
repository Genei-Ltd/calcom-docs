...
# Create a Slack push linking intent



## OpenAPI

````yaml /api-reference/v2/openapi.json post /v2/notifications/subscriptions/slack/link-intents
openapi: 3.0.0
info:
...
paths:
  /v2/notifications/subscriptions/slack/link-intents:
    post:
      tags:
        - Notifications
      summary: Create a Slack push linking intent
      operationId: NotificationsChatSubscriptionsController_createSlackLinkIntent
      parameters:
        - name: Authorization
          in: header
          description: >-
