...
````yaml /api-reference/v2/openapi.json post /v2/verified-resources/emails/verification-code/request
openapi: 3.0.0
info:
  ...
  /v2/verified-resources/emails/verification-code/request:
    post:
      ...
      description: >-
        ...
        access token, the `VERIFIED_RESOURCES_WRITE` scope is required.
