...
````yaml /api-reference/v2/openapi.json delete /v2/organizations/{orgId}/teams/{teamId}/workflows/{workflowId}/routing-form
openapi: 3.0.0
info:
...
paths:
  /v2/organizations/{orgId}/teams/{teamId}/workflows/{workflowId}/routing-form:
    delete:
      ...
      operationId: OrganizationTeamWorkflowsController_deleteRoutingFormWorkflow
      parameters:
        - name: Authorization
          in: header
          description: >-
