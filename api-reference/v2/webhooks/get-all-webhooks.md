...
````yaml /api-reference/v2/openapi.json get /v2/webhooks
openapi: 3.0.0
info:
...
paths:
  /v2/webhooks:
    get:
      ...
      description: >-
        Gets a paginated list of webhooks for the authenticated user. If
        accessed using an OAuth access token, the `WEBHOOK_READ` scope is
        required.
