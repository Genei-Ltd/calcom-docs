...
````yaml /api-reference/v2/openapi.json delete /v2/organizations/{orgId}/organizations/{managedOrganizationId}
openapi: 3.0.0
info:
  ...
  /v2/organizations/{orgId}/organizations/{managedOrganizationId}:
    delete:
      ...
      description: >-
        ...
        `organization.delete`. Learn more about API access control at
