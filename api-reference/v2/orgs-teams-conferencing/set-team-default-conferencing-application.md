...
````yaml /api-reference/v2/openapi.json post /v2/organizations/{orgId}/teams/{teamId}/conferencing/{app}/default
openapi: 3.0.0
info:
...
paths:
  /v2/organizations/{orgId}/teams/{teamId}/conferencing/{app}/default:
    post:
      ...
      operationId: OrganizationsConferencingController_setTeamDefaultApp
      parameters:
        - name: teamId
          required: true
          in: path
