...
````yaml /api-reference/v2/openapi.json patch /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields
openapi: 3.0.0
info:
...
paths:
  /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields:
    patch:
      tags:
        - Team Event Types
      summary: Update team booking fields
      description: >-
      ...
      operationId: TeamsEventTypesController_2026_06_12_updateBookingFields
      parameters:
