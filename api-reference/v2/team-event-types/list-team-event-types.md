...
````yaml /api-reference/v2/openapi.json get /v2/teams/{teamId}/event-types
openapi: 3.0.0
info:
...
paths:
  /v2/teams/{teamId}/event-types:
    get:
      ...
      operationId: TeamsEventTypesController_2026_06_12_getTeamEventTypes
      parameters:
