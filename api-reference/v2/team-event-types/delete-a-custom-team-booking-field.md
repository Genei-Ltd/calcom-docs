...
# Delete a custom team booking field
...
````yaml /api-reference/v2/openapi.json delete /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields/{slug}
openapi: 3.0.0
info:
...
tags: []
paths:
  /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields/{slug}:
    delete:
      tags:
        - Team Event Types
      summary: Delete a custom team booking field
      description: >-
        ...
        is required.
      operationId: TeamsEventTypesController_2026_06_12_deleteCustomBookingField
      parameters:
