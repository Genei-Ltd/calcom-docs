...
tags: []
paths:
  /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields:
    get:
      tags:
        - Team Event Types
      summary: Get team booking fields
      description: >-
        ...
        Returns default and custom booking fields, plus any read-only
        workflow-added fields. Required membership role: `team admin`. PBAC
        permission: `eventType.readTeamEventTypes`. Learn more about API access
        control at https://cal.com/docs/api-reference/v2/access-control. If
        accessed using an OAuth access token, the `TEAM_EVENT_TYPE_READ` scope
        is required.
      operationId: TeamsEventTypesController_2026_06_12_getBookingFields
      parameters:
