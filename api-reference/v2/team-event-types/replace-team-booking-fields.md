...
````yaml /api-reference/v2/openapi.json put /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields
openapi: 3.0.0
info:
...
paths:
  /v2/teams/{teamId}/event-types/{eventTypeId}/booking-fields:
    put:
      tags:
        - Team Event Types
      summary: Replace team booking fields
      description: >-
        ...
        and ignored. Required membership role: `team admin`. PBAC permission:
      ...
      operationId: TeamsEventTypesController_2026_06_12_replaceBookingFields
      parameters:
