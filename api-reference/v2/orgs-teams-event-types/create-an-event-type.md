  ...
  /v2/organizations/{orgId}/teams/{teamId}/event-types:
    post:
      ...
      description: >-
        ...
        `eventType.create`. Learn more about API access control at
    ...
    CreateTeamEventTypeInput_2024_06_14:
      ...
      properties:
        ...
        bookingFields:
          type: array
          description: >-
            Custom fields that can be added to the booking form when the event
            is booked by someone. By default booking form has name and email
            field.
          items:
            oneOf:
        ...
        privateNoteTemplate:
          ...
          example: Meeting with {Attendee name} for {Event type title}
        schedulingType:
          type: string
          enum:
            - collective
    ...
    EmailDefaultFieldInput_2024_06_14:
      ...
      properties:
        ...
        required:
          ...
          default: true
          description: >-
            Pass booking field {type: "phone", slug: "attendeePhoneNumber",
      ...
      properties:
        ...
        disableOnPrefill:
          ...
          description: >-
            ...
            See guide https://cal.com/docs/platform/guides/booking-fields
      required:
        - slug
