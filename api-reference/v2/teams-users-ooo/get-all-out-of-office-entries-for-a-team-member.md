...
````yaml /api-reference/v2/openapi.json get /v2/teams/{teamId}/users/{userId}/ooo
openapi: 3.0.0
info:
...
paths:
  /v2/teams/{teamId}/users/{userId}/ooo:
    get:
      tags:
        - Teams / Users / OOO
      summary: Get all out-of-office entries for a team member
      description: >-
        If accessed using an OAuth access token, the `TEAM_SCHEDULE_READ` scope
        is required.
      operationId: TeamsOOOController_getTeamMemberOOO
      parameters:
        - name: Authorization
          in: header
          description: >-
