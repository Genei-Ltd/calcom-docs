...
````yaml /api-reference/v2/openapi.json post /v2/teams/{teamId}/users/{userId}/ooo
openapi: 3.0.0
info:
...
paths:
  /v2/teams/{teamId}/users/{userId}/ooo:
    post:
      tags:
        - Teams / Users / OOO
      summary: Create an out-of-office entry for a team member
      description: >-
        If accessed using an OAuth access token, the `TEAM_SCHEDULE_WRITE` scope
        is required.
      operationId: TeamsOOOController_createTeamMemberOOO
      parameters:
        - name: Authorization
          in: header
          description: >-
