...
````yaml /api-reference/v2/openapi.json delete /v2/teams/{teamId}/users/{userId}/ooo/{oooId}
openapi: 3.0.0
info:
...
paths:
  /v2/teams/{teamId}/users/{userId}/ooo/{oooId}:
    delete:
      tags:
        - Teams / Users / OOO
      summary: Delete an out-of-office entry for a team member
      description: >-
        If accessed using an OAuth access token, the `TEAM_SCHEDULE_WRITE` scope
        is required.
      operationId: TeamsOOOController_deleteTeamMemberOOO
      parameters:
        - name: Authorization
          in: header
          description: >-
